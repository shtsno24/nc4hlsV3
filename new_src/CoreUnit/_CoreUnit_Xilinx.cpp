...
#pragma HLS RESOURCE variable=_weight_port core=RAM_T2P_BRAM
#pragma HLS dependence variable=_weight_port inter false
    data_type _src_data_port[data_bank_size];
#pragma HLS RESOURCE variable=_src_data_port core=RAM_T2P_BRAM
#pragma HLS dependence variable=_src_data_port inter false
    data_type _dst_data_port[data_bank_size];
#pragma HLS RESOURCE variable=_dst_data_port core=RAM_T2P_BRAM
#pragma HLS dependence variable=_dst_data_port inter false
    int64_t loop_limit;
