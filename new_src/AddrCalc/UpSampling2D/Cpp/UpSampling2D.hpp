...
#pragma HLS array_partition variable=addr_dst_base_vec complete dim=0
#pragma HLS dependence variable=addr_dst_base_vec inter false
...
#pragma HLS RESOURCE variable=k_w core=AddSub_DSP
            k_w += 1;
#pragma HLS RESOURCE variable=dst_offset core=AddSub_DSP
