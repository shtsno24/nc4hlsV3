        ...
        try:
            ...
            for i in range(self.THREAD_NUM_REG):
                if self.INVALID_THREAD_IN_VEC[i] == 2:
                    ...
                    self.DATA_OUT_VEC[i] = self.DATA_IN_VEC[i] if self.DATA_IN_VEC[i] > self.DATA_OUT_VEC[i] else self.DATA_OUT_VEC[i]
            ...
            for i in range(self.THREAD_NUM_REG):
                if self.ISVALID_SRC_VEC[i] == 2:
                    ...
                    self.DATA_DST_VEC[i] = self.DATA_SRC_VEC[i] if self.DATA_SRC_VEC[i] > self.DATA_DST_VEC[i] else self.DATA_DST_VEC[i]
...
class Decoder():
    ...
    def ADDR_CALC(self, cnt_src_reg, t):
        ...
        _isvalid = 1 if cnt_kernel != 0 else 2
