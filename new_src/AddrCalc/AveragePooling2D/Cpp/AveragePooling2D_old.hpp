...
namespace averagepooling2d{
    ...
    void decoder(addr_t src_height, addr_t src_width, addr_t src_depth, addr_t src_limit,
        ...
        static addr_t is_valid, weight_addr, bias_addr;
...
#pragma HLS UNROLL
                ...
                if (src_w >= const_vec[1]){  // TODO : "(src_width - kernel_width + 1)" is a const. -> const_vec[1]
                    ...
                    src_hw += const_vec[3];  // TODO : "(src_height - kernel_height + 1)" is a const. -> const_vec[3]
                }
                ...
                if (src_h >= const_vec[4]){  // TODO : "(src_height - kernel_height + 1)" is a const. -> const_vec[4]
                    ...
                    // src_hw -= (src_height - kernel_height) * src_width * src_depth;   // TODO : "(src_height - kernel_height) * src_width * src_depth * src_depth" is a const. -> const_vec[5]
                    src_hw -= const_vec[5];
                }
