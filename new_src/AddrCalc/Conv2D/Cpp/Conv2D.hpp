...
namespace conv2d{
    ...
    void decoder(addr_t src_height, addr_t src_width, addr_t src_depth, addr_t src_limit,
        ...
        static addr_t src_d, src_w, src_h, src_hw;
        static addr_t src_offset, kernel_offset;
...
#pragma HLS array_partition variable=addr_weight_base_vec complete dim=0
#pragma HLS dependence variable=addr_weight_base_vec inter false
...
#pragma HLS UNROLL
                    if (isvalid_src_vec[i] != 0){
                        ...
                        if (_cnt_kernel == const_vec[5]){   // TODO : "(kernel_size * src_depth - 1)" is a const. -> const_vec[5]
                            isvalid_src_vec[i] = 3;
                        } else {
                            isvalid_src_vec[i] = 1;
                        }
...
#pragma HLS RESOURCE variable=_cnt_kernel core=AddSub_DSP
            _cnt_kernel += 1;
#pragma HLS RESOURCE variable=kernel_offset core=AddSub_DSP
