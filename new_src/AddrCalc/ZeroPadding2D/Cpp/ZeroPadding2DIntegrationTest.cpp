...
int main(){
    ...
    constexpr addr_t pad_top = 1;
    constexpr addr_t pad_bottom = 2;
    constexpr addr_t pad_left = 3;
    constexpr addr_t pad_right = 4;

    const addr_t dst_height = src_height + pad_top + pad_bottom;
    const addr_t dst_width = src_width + pad_left + pad_right;
    ...
    std::ofstream _result_file("./log/result_zeropadding2d.md");
    _result_file << "# ZEROPADDING2D_TEST"  << std::endl << std::endl;
    ...
    std::ofstream _dump_file("./log/dump_zeropadding2d_decoder_.md");
    _dump_file << "# ZEROPADDING2D_DECODER_TEST" << std::endl << std::endl;
    _dump_file << "## TEST_0 (reset)" << std::endl << std::endl;
    zeropadding2d::decoder<data_t, addr_t, signal_t, thread_num>(src_height, src_width, src_depth, src_limit,
    ...
    // Execute
    #ifdef DUMP_LOG_CP
    std::ofstream __dump_file("./log/dump_zeropadding2d_layer_.md");
