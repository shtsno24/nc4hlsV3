...
int main(){
    std::ofstream _dump_file("./log/dump_zeropadding2d_decoder.md");
    ...
    std::ofstream _result_file("./log/result_zeropadding2d_decoder.md");
    _result_file << "# ZEROPADDING2D_DECODER_TEST"  << std::endl << std::endl;
