...
if __name__ == "__main__":
    try:
        ...
        utils.copy_files(["GenerateSharedObject.sh"], code_path + "/IPUnit/", ["./Generated/CPU/"])
        print("\n\n\n----Generate Configs---\n\n\n")
        GenerateConfigs.GenerateConfigJSON(model_dict, opcodes, memory_bank, export_file_name="./Generated/PYNQ/Config.json", print_debug=True)
        print("\n\n\n----Generate Weights---\n\n\n")
        GenerateConfigs.ExportWeights(model_dict, file_name="./Generated/PYNQ/Weights.bin", print_debug=True)
