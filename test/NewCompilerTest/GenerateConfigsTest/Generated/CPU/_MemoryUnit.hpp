...
//                 data_cache_a[j] = DATA_READ_VEC[i];
//             }
//         }
...
//                 data_cache_b[j] = DATA_READ_VEC[i];
//             }
//         }
...
//                 data_weight_cache[j] = DATA_WEIGHT_VEC[i];
//                 data_bias_cache[j] = DATA_BIAS_VEC[i];
//                 data_mean_cache[j] = DATA_MEAN_VEC[i];
//             }
//         }
        #ifdef DUMP_LOG_WEIGHT_BANK
